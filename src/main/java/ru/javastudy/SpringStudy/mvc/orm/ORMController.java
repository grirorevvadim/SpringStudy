...
public class ORMController {
    ...
    @RequestMapping(value = "/queryFindByUsername/{username:.+}", method = RequestMethod.GET)
    public ModelAndView queryFindByUsername(@PathVariable("username") String username) {
        System.out.println("ORMController queryFindByIdUser is called");
        User user = ormService.queryFindUserByUsername(username);
        return new ModelAndView("/orm/orm", "resultObject", user);
    }

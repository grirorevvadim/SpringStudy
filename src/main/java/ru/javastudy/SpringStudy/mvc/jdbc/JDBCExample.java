package ru.javastudy.SpringStudy.mvc.jdbc;
...
import ru.javastudy.SpringStudy.mvc.bean.DBLog;
...
public class JDBCExample {
    ...
    public List<User> queryAllUsers() {
        ...
        List<User> userList = this.jdbcTemplate.query(QUERY_SQL, (resulSet, rowNum) -> {
            User user = new User();
